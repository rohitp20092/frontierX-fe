...
export const ElementRightContainer = () => {
  return (
    <div className="w-full px-5 pb-5 scroll-custom rounded-md rounded-tl-none rounded-tr-none bg-[#16101a] text-white -mt-1">
      <div className="max-h-[300px] overflow-y-scroll duration-100 delay-100	">
        <div className='mr-5'>
          ...
          {[1, 2, 3].map((value, index) => (
            <div key={value} className="flex gap-1 md:gap-0 lg:gap-3 flex-wrap lg:flex-nowrap">
